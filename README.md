...
# ulackroad uusiness intelligence
...
**ulackroad uusiness intelligence** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
```bash
curl -O https://raw.githubusercontent.com/BlackRoad-OS/blackroad-business-intelligence/main/blackroad-business-intelligence.sh
chmod +x blackroad-business-intelligence.sh
./blackroad-business-intelligence.sh
```
